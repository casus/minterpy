...
class LagrangePolynomial(MultivariatePolynomialSingleABC):
    ...
    def newt_coeffs_lagr_monomials(self) -> ARRAY:
        ...
        Return the coefficients of the respective polynomial in Newton base. Internally, this instance is transformed to Newton base using :class:`TransformationLagrangeToNewton`.

        :return: respective Newton coefficients.
        :rtype: np.ndarray
    ...
    def eval_lagrange_monomials_on(self, points: ARRAY) -> ARRAY:
        ...
        computes the values of all Lagrange monomials at all k input points, where internally the polynomial is transformed to Newton base.
