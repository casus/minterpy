...
class CanonicalPolyArithmeticTest(unittest.TestCase):
    ...
    def test_neg(self):
        ...
        np.testing.assert_almost_equal(res.multi_index.exponents, self.p1.multi_index.exponents, decimal=DESIRED_PRECISION)
        np.testing.assert_almost_equal(res.coeffs, groundtruth_coeffs, decimal=DESIRED_PRECISION)
    ...
    def test_add_different_poly(self):
        ...
        np.testing.assert_almost_equal(res.multi_index.exponents, groundtruth_multi_index_exponents, decimal=DESIRED_PRECISION)
        np.testing.assert_almost_equal(res.coeffs, groundtruth_coeffs, decimal=DESIRED_PRECISION)
